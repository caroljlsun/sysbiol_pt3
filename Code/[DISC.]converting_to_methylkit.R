readBismarkProcessed<-function( location,sample.id,assembly="unknown",treatment,
...
sample_ids <- list("sample_F_B_10", "sample_F_B_12", "sample_F_T_13", "sample_F_T_15")
...
small_group_methyl <- readBismarkProcessed(small_group_of_tsv,
